    ...
    return (
        ...
        <div className="make_schedule_text">
            ...
            <span>Select Day of Week</span>
                ...
                <select id="start_hour" name="start_hour" value={startHour}
                ...
                :
                <select id="start_minute" name="start_minute" value={startMinute}
                ...
                <select id="end_hour" name="end_hour" value={endHour}
                ...
                :
                <select id="end_minute" name="end_minute" value={endMinute}
                ...
                <div></div>
            <button type="button" className = "submit_fixed_button" onClick={onSubmit}>Submit Fixed Event</button>
        </div>
        </>
    )
}
